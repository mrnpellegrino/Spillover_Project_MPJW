...
removeWords<- function(str,stopwords){Spillover_Mainsheet2<-unlist(strsplit(str,"rodents"))
paste(Spillover_Mainsheet2[!Spillover_Mainsheet2 %in% stopwords],collapse="rodents")}
removeWords(str, rodents)
